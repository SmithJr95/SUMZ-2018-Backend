...
@Component
public class IsValidAccountingFigureCombinationPostRequestValidator implements ConstraintValidator<IsValidAccountingFigureCombinationPostRequest, ScenarioPostRequestDto> {
